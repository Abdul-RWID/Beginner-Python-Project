...
####################################
def intro():
    print('Day 1 : You\'re going to be learning about DATA TYPES, NUMBERS, TYPE CONVERSION & F-STRINGS')
    print('Type "1" for Exercise 1 - Data Types')
    print('Type "2" for Exercise 2 - BMI Calculator')
    print('Type "3" for Exercise 3 - Life in Weeks')
    print('Type "4" for Day 2 Project: Tip Calculator')
