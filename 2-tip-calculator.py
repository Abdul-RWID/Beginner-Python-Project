...
print(f'tip_as_percent = tip / 100 = {tip_as_percent}')
...
print(f'bill_per_person = total_bill / people = {bill_per_person}')
final_amount = round(bill_per_person, 2)       # Change value round to 2 decimal places
