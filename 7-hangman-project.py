# You're going to be learning about How to Make Hangman Game
...
def day7():
    '''
    Day 7 - Hangman Project - How to Add ASCII Art and Improve the UI
    '''
    import random
    # import  os
    ...
    print(logo)
    print(f'You have {lives} live left to answer the words')
